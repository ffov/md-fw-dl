...
url: "http://images.freifunk-ostvest.de/{{parse(downloadableSite).id}}/versions/v{{parse(downloadableSite).version}}/{{selectedMode}}/gluon-ffov{{parse(downloadableSite).short}}-v" +
