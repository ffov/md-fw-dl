...
sites:{
  "domaene01" : {id: "dom01",short:"d01",name:"Münster Stadt", version:"2.1.0", version_base:"2016.2.1", on_map: true },
  // "domaene02" : {id: "dom02",short:"d02",name:"Kreis Coesfeld", version:"2.1.0", version_base:"2016.2.1", on_map: false },
  // "domaene03" : {id: "dom03",short:"d03",name:"Kreis Steinfurt West", version:"2.1.0", version_base:"2016.2.1", on_map: false },
  // "domaene04" : {id: "dom04",short:"d04",name:"Kreis Steinfurt Ost", version:"2.1.0", version_base:"2016.2.1", on_map: false },
  "domaene05" : {id: "dom05",short:"d05",name:"Münster Süd", version:"2.1.0", version_base:"2016.2.1", on_map: true },
  //"domaene06" : {id: "dom06",short:"d06",name:"Westmünsterland", version:"2.1.0", version_base:"2016.2.1", on_map: false },
  "domaene07" : {id: "dom07",short:"d07",name:"Telgte", version:"2.1.3", version_base:"2016.2.1", on_map: true },
  "domaene08" : {id: "dom08",short:"d08",name:"Gescher", version:"2.1.0", version_base:"2016.2.1", on_map: true },
  "domaene09" : {id: "dom09",short:"d09",name:"Stadtlohn", version:"2.1.0", version_base:"2016.2.1", on_map: true },
  // "domaene10" : {id: "dom10",short:"d10",name:"Testdomäne", version:"2.1.0", version_base:"2016.2.1", on_map: false },
  "domaene11" : {id: "dom11",short:"d11",name:"Bocholt", version:"2.1.0", version_base:"2016.2.1", on_map: true },
  "domaene12" : {id: "dom12",short:"d12",name:"Dülmen (ohne Rorup)", version:"2.1.0", version_base:"2016.2.1", on_map: true },
  "domaene13" : {id: "dom13",short:"d13",name:"Rorup", version:"2.1.0", version_base:"2016.2.1", on_map: true },
  "domaene14" : {id: "dom14",short:"d14",name:"Dingden", version:"2.1.0", version_base:"2016.2.1", on_map: true },
  "domaene15" : {id: "dom15",short:"d15",name:"Heek", version:"2.1.0", version_base:"2016.2.1", on_map: true},
  "domaene16" : {id: "dom16",short:"d16",name:"Münster Promenade", version:"2.1.0", version_base:"2016.2.1", on_map: true },
  "domaene17" : {id: "dom17",short:"d17",name:"Emsdetten", version:"2.1.0", version_base:"2016.2.1", on_map: true },
  "domaene18" : {id: "dom18",short:"d18",name:"Greven", version:"2.1.0", version_base:"2016.2.1", on_map: true },
  "domaene19" : {id: "dom19",short:"d19",name:"Neuenkirchen", version:"2.1.0", version_base:"2016.2.1", on_map: true },
  "domaene20" : {id: "dom20",short:"d20",name:"Ochtrup", version:"2.1.0", version_base:"2016.2.1", on_map: true },
  "domaene21" : {id: "dom21",short:"d21",name:"Rheine", version:"2.1.0", version_base:"2016.2.1", on_map: true },
  "domaene22" : {id: "dom22",short:"d22",name:"Steinfurt", version:"2.1.0", version_base:"2016.2.1", on_map: true },
  "domaene23" : {id: "dom23",short:"d23",name:"Metelen", version:"2.1.0", version_base:"2016.2.1", on_map: true },
  "domaene24" : {id: "dom24",short:"d24",name:"Wettringen", version:"2.1.0", version_base:"2016.2.1", on_map: true },
  "domaene25" : {id: "dom25",short:"d25",name:"Steinfurt-Ost", version:"2.1.0", version_base:"2016.2.1", on_map: true },
  "domaene26" : {id: "dom26",short:"d26",name:"Borken", version:"2.1.0", version_base:"2016.2.1", on_map: true },
  "domaene27" : {id: "dom27",short:"d27",name:"Selm", version:"2.1.0", version_base:"2016.2.1", on_map: true },
  "domaene28" : {id: "dom28",short:"d28",name:"Horstmar", version:"2.1.0", version_base:"2016.2.1", on_map: true},
  "domaene29" : {id: "dom29",short:"d29",name:"Laer", version:"2.1.0", version_base:"2016.2.1", on_map: true},
  "domaene30" : {id: "dom30",short:"d30",name:"Nordwalde", version:"2.1.0", version_base:"2016.2.1", on_map: true},
  "domaene31" : {id: "dom31",short:"d31",name:"Altenberge", version:"2.1.0", version_base:"2016.2.1", on_map: true},
  "domaene32" : {id: "dom32",short:"d32",name:"Ahlen", version:"2.1.0", version_base:"2016.2.1", on_map: true},
  "domaene33" : {id: "dom33",short:"d33",name:"Beckum", version:"2.1.0", version_base:"2016.2.1", on_map: true},
  "domaene34" : {id: "dom34",short:"d34",name:"Beelen", version:"2.1.0", version_base:"2016.2.1", on_map: true},
  "domaene35" : {id: "dom35",short:"d35",name:"Drensteinfurt", version:"2.1.0", version_base:"2016.2.1", on_map: true},
  "domaene36" : {id: "dom36",short:"d36",name:"Ennigerloh", version:"2.1.0", version_base:"2016.2.1", on_map: true},
  "domaene37" : {id: "dom37",short:"d37",name:"Everswinkel", version:"2.1.0", version_base:"2016.2.1", on_map: true},
  "domaene38" : {id: "dom38",short:"d38",name:"Oelde", version:"2.1.0", version_base:"2016.2.1", on_map: true},
  "domaene39" : {id: "dom39",short:"d39",name:"Ostbevern", version:"2.1.0", version_base:"2016.2.1", on_map: true},
  "domaene40" : {id: "dom40",short:"d40",name:"Sassenberg", version:"2.1.0", version_base:"2016.2.1", on_map: true},
  "domaene41" : {id: "dom41",short:"d41",name:"Sendenhorst", version:"2.1.0", version_base:"2016.2.1", on_map: true},
  "domaene42" : {id: "dom42",short:"d42",name:"Wadersloh", version:"2.1.0", version_base:"2016.2.1", on_map: true},
  "domaene43" : {id: "dom43",short:"d43",name:"Warendorf", version:"2.1.0", version_base:"2016.2.1", on_map: true},
  "domaene44" : {id: "dom44",short:"d44",name:"Ascheberg", version:"2.1.0", version_base:"2016.2.1", on_map: true},
  "domaene45" : {id: "dom45",short:"d45",name:"Billerbeck", version:"2.1.0", version_base:"2016.2.1", on_map: true},
  "domaene46" : {id: "dom46",short:"d46",name:"Coesfeld", version:"2.1.0", version_base:"2016.2.1", on_map: true},
  "domaene47" : {id: "dom47",short:"d47",name:"Havixbeck", version:"2.1.0", version_base:"2016.2.1", on_map: true},
  "domaene48" : {id: "dom48",short:"d48",name:"Lüdinghausen", version:"2.1.0", version_base:"2016.2.1", on_map: true},
  "domaene49" : {id: "dom49",short:"d49",name:"Nordkirchen", version:"2.1.0", version_base:"2016.2.1", on_map: true},
  "domaene50" : {id: "dom50",short:"d50",name:"Nottuln", version:"2.1.0", version_base:"2016.2.1", on_map: true},
  "domaene51" : {id: "dom51",short:"d51",name:"Olfen", version:"2.1.0", version_base:"2016.2.1", on_map: true},
  "domaene52" : {id: "dom52",short:"d52",name:"Rosendahl", version:"2.1.0", version_base:"2016.2.1", on_map: true},
  "domaene53" : {id: "dom53",short:"d53",name:"Senden", version:"2.1.0", version_base:"2016.2.1", on_map: true},
  "domaene54" : {id: "dom54",short:"d54",name:"Ahaus", version:"2.1.0", version_base:"2016.2.1", on_map: true},
  "domaene55" : {id: "dom55",short:"d55",name:"Heiden", version:"2.1.0", version_base:"2016.2.1", on_map: true},
  "domaene56" : {id: "dom56",short:"d56",name:"Isselburg", version:"2.1.0", version_base:"2016.2.1", on_map: true},
  "domaene57" : {id: "dom57",short:"d57",name:"Legden", version:"2.1.0", version_base:"2016.2.1", on_map: true},
  "domaene58" : {id: "dom58",short:"d58",name:"Reken", version:"2.1.0", version_base:"2016.2.1", on_map: true},
  "domaene59" : {id: "dom59",short:"d59",name:"Rhede", version:"2.1.0", version_base:"2016.2.1", on_map: true},
  "domaene60" : {id: "dom60",short:"d60",name:"Schöppingen", version:"2.1.0", version_base:"2016.2.1", on_map: true},
  "domaene61" : {id: "dom61",short:"d61",name:"Südlohn", version:"2.1.0", version_base:"2016.2.1", on_map: true},
  "domaene62" : {id: "dom62",short:"d62",name:"Velen", version:"2.1.0", version_base:"2016.2.1", on_map: true},
  "domaene63" : {id: "dom63",short:"d63",name:"Vreden", version:"2.1.0", version_base:"2016.2.1", on_map: true}
  // "domaene64" : {id: "dom64",short:"d64",name:"Gronau Test", version:"2.1.0", version_base:"2016.2.1", on_map: false},
  // "domaene65" : {id: "dom62",short:"d62",name:"Ramschdomäne", version:"2.1.0", version_base:"2016.2.1", on_map: false},  
},
