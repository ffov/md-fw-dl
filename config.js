...
url: "http://images.freifunk-ostvest.de/{{parse(downloadableSite).id}}/versions/v{{parse(downloadableSite).version}}/{{selectedMode}}/gluon-ffel{{parse(downloadableSite).short}}-v" +
